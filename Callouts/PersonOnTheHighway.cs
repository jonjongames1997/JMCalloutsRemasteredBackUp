...
namespace JMCalloutsRemastered.Callouts
{
    ...
    public class PersonOnTheHighway : Callout
    {
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            {
                LSPD_First_Response.Mod.API.Functions.RequestBackup(spawnpoint, LSPD_First_Response.EBackupResponseType.Code2, LSPD_First_Response.EBackupUnitType.StateUnit);
            }
            else
            {
