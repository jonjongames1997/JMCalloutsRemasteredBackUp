...
namespace JMCalloutsRemastered.Callouts
{
    ...
    [CalloutInterface("[JM Callouts] Stolen Construction Equipment", CalloutProbability.High, "Reports of stolen construction equipment.", "Code 3", "LSPD")]
    ...
    public class StolenConstructionEquipment : Callout
    {
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            if (Settings.ActivateAIBackup)
            {
                ...
                LSPD_First_Response.Mod.API.Functions.RequestBackup(spawnpoint, LSPD_First_Response.EBackupResponseType.Pursuit, LSPD_First_Response.EBackupUnitType.LocalUnit);
                LSPD_First_Response.Mod.API.Functions.RequestBackup(spawnpoint, LSPD_First_Response.EBackupResponseType.Pursuit, LSPD_First_Response.EBackupUnitType.StateUnit);
            }
            else
            {
