...
namespace JMCalloutsRemastered.Callouts
{
    ...
    public class IntoxicatedIndividual : Callout
    {
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            {
                LSPD_First_Response.Mod.API.Functions.RequestBackup(Spawnnpoint, LSPD_First_Response.EBackupResponseType.Code2, LSPD_First_Response.EBackupUnitType.LocalUnit);
            }
            else
            {
