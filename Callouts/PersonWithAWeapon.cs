...
namespace JMCalloutsRemastered.Callouts
{
    ...
    public class PersonWithAWeapon : Callout
    {
        ...
        public override bool OnCalloutAccepted()
        {
            ...
            Game.DisplayNotification("web_jonjongames", "web_jonjongames", "~w~JM Callouts Remastered", "~w~Person With A Weapon", "~b~Dispatch: The suspect has been spotted with a firearm! Respond ~r~Code 3");
