...
namespace JMCalloutsRemastered.Callouts
{
    ...
    [CalloutInterface("[JM Callouts] Bounty Hunter Requiring Assistance", CalloutProbability.Medium, "A bounty hunter requiring assistance", "CODE 2", "LSPD")]

    public class BountyHunterRequiringAssistance : Callout
    {
